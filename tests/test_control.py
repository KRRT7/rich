from rich.control import Control, translate_control_codes
...
def test_strip_control_codes():
    assert translate_control_codes("") == ""
    assert translate_control_codes("foo\rbar") == "foobar"
    assert translate_control_codes("Fear is the mind killer") == "Fear is the mind killer"


def test_escape_control_codes():
    assert translate_control_codes("", escape=True) == ""
    assert translate_control_codes("foo\rbar", escape=True) == "foo\\rbar"
    assert translate_control_codes("Fear is the mind killer", escape=True) == "Fear is the mind killer"
